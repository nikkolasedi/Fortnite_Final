...
public class DefaultSkins extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_default_skins);
        ...
        click(imageButton1,"fortnite_outfit_default1");
        click(imageButton2,"fortnite_outfit_default2");
        click(imageButton3,"fortnite_outfit_default3");
        click(imageButton4,"fortnite_outfit_default4");
        click(imageButton5,"fortnite_outfit_default5");
        click(imageButton6,"fortnite_outfit_default6");
        click(imageButton7,"fortnite_outfit_default7");
        click(imageButton8,"fortnite_outfit_default8");
    }
    ...
    public void send(View v, String imageName){
        ...
        Intent i = new Intent(DefaultSkins.this, PopUpActivity.class);
